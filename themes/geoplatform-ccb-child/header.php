    ...
    if( $font_choice != '' ) {
        switch ( $font_choice ) {
            case 'lato':
                ...
                echo "body { font-family: 'Slabo 27px', sans-serif !important;}";
                echo '</style>';
                break;
            case 'slabo':
                echo '<style type="text/css">';
                echo "body { font-family: 'Lato', serif !important; }";
                echo '</style>';
                break;
                    ...
                    <li>
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-link header__btn dropdown-toggle"
                                ...
                                <span class="hidden-xs">Menu Dropdown Thing <span class="caret"></span></span>
                            </button>
                        </div>
                    </li>
                        ...
                        <div class="btn-account btn-group">
                            ...
                            <?php if (!is_user_logged_in()){?>
                              <a href="<?php echo esc_url(wp_login_url( get_option('siteurl') ) ); ?>">
                                  <button style="color:lightblue;" type="button" class="btn btn-link" onclick="login">Log In</button>
                                </a>
                          <?php  } else {?>
                            <a href="<?php echo esc_url(wp_logout_url( home_url() ) ); ?>">
                                <button style="color:lightblue;" type="button" class="btn btn-link">Log Out</button>
                              </a>
                            <?php } ?>
