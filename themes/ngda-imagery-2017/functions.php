...
function geo_customize_register( $wp_customize )
{
    ...
    $wp_customize->add_section( 'header_color_section' , array(
        'title'    => __( 'Header Color Section', 'ngda-imagery-2017' ),
        'priority' => 30
    ) );
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_link_color', array(
				'label'    => __( 'Header1 Color', 'ngda-imagery-2017' ),
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'h2_link_color', array(
				'label'    => __( 'Header 2 Color', 'ngda-imagery-2017' ),
				'section'  => 'header_color_section',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'h3_link_color', array(
				'label'    => __( 'Header 3 Color', 'ngda-imagery-2017' ),
				'section'  => 'header_color_section',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'h4_link_color', array(
				'label'    => __( 'Header 4 Color', 'ngda-imagery-2017' ),
				'section'  => 'header_color_section',
    ...
    //link (<a>) color and control
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'a_link_color', array(
				'label'    => __( 'Link Color', 'ngda-imagery-2017' ),
				'section'  => 'header_color_section',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'brand_color', array(
				'label'    => __( 'Brand Color', 'ngda-imagery-2017' ),
				'section'  => 'header_color_section',
		...
		$wp_customize->add_section( 'font_section' , array(
				'title'    => __( 'Font Section', 'ngda-imagery-2017' ),
				'priority' => 50
			) );
        ...
        'choices' => array(
            'lato' => __('Lato', 'ngda-imagery-2017'),
            'slabo' => __('Slabo',  'ngda-imagery-2017')
						),
				));
		...
		$wp_customize->add_section( 'banner_text_section' , array(
				'title'    => __( 'Banner Area', 'ngda-imagery-2017' ),
				'priority' => 50
			) );
         ...
         $wp_customize->add_control( new Text_Editor_Custom_Control( $wp_customize, 'text_editor_setting', array(
             'label'   => __( 'Banner Text Editor', 'ngda-imagery-2017' ),
             ...
             'priority' => 10
				 ...
				 $wp_customize->add_control('call2action_button', array(
					 'section' => 'banner_text_section',
					 'label' =>__( 'Show Call to Action button?', 'ngda-imagery-2017' ),
					 'type' => 'checkbox',
					 'priority' => 20,
				 ) );
				 ...
				 $wp_customize->add_control('call2action_text', array(
					 'section' => 'banner_text_section',
					 'label' =>__( 'Button Text', 'ngda-imagery-2017' ),
					 'type' => 'text',
					 'priority' => 30,
				 ) );
				...
				$wp_customize->add_control('call2action_url', array(
					'section' => 'banner_text_section',
					'label' =>__( 'Button URL', 'ngda-imagery-2017' ),
					'type' => 'URL',
					'priority' => 40,
				) );
			...
			$wp_customize->add_section( 'custom_links_section' , array(
				'title'    => __( 'Custom Links Section', 'ngda-imagery-2017' ),
				'priority' => 60
			) );
			...
			$wp_customize->add_control( 'Map_Gallery_link_box', array(
				...
				$wp_customize->add_section( 'community_info_section' , array(
						'title'    => __( 'Community Info Sidebar', 'ngda-imagery-2017' ),
						'priority' => 70
				) );
...
function wysiwyg_register_custom_meta_box()
 {
 add_meta_box(WYSIWYG_META_BOX_ID, __('Banner Area Custom Content', 'ngda-imagery-2017') , 'custom_wysiwyg', 'post');
 add_meta_box(WYSIWYG_META_BOX_ID, __('Banner Area Custom Content', 'ngda-imagery-2017') , 'custom_wysiwyg', 'page');
 }
...
function geoplatform_sidebar() {
    ...
    register_sidebar(
        array(
            ...
            'name' => __( 'Sidebar Widget', 'ngda-imagery-2017' ),
            'description' => __( 'Widgets that go in the sidebar can be added here', 'ngda-imagery-2017' ),
                        'class' => 'widget-class',
...
//-------------------------------
// Allow logged in users to see private posts and pages
//-------------------------------
