...
<div class="apps-and-services section--linked">
    ...
    <div class="container">
      <h4 class="heading text-centered">
          <div class="line"></div>
          <div class="title darkened">Apps &amp; Services</div>
      </h4>
      <br><br>
        <div class="row">

            <div class="col-sm-6">
                <img src="wp-content/uploads/2017/01/services_md.jpeg" class="img--prominent">
            </div><!--#col-sm-6-->
            <div class="col-sm-6">
                ...
                <div class="text-centered">
                    <a class="btn btn-info" href="applications-and-services">View GeoPlatform Services</a>
                </div><!--#text-centered-->
