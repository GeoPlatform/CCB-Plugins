...
<?php } ?>
<!-- <?php
                  // echo '<p>' . sprintf( esc_html__( 'Category: %s', 'geoplatform-2017-theme' ), $category_link ) . '</p> ';
                  // echo '<p>' . sprintf( esc_html__( 'Description: %s', 'geoplatform-2017-theme' ), $category->description ) . '</p>';
                  // echo '<p>' . sprintf( esc_html__( 'Post Count: %s', 'geoplatform-2017-theme' ), $category->count ) . '</p>';
              //} ?> -->
