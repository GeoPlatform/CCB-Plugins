<?php
/*
Template Name: NGDA Meeetings Archives
*/
get_header();
...
<div class="container">
    ...
    <div class="row">
      <div class="col-md-8 col-sm-8">
        <?php //get the archive of ngda-meetings
        // $args = array(
        //   'format'=> 'option',
        //   'post_type'=> 'ngda_meetings',
        //   'type' => 'alpha'
        // );
        //form setup for dropdown
        //make every option in the dropdown one of the available posts
        //when clicking on the post, update the content below to the selected option
        //showcase the content of the currently selected post
        the_content();
        ?>
        <br />
        <h2>NGDA Meetings</h2>
