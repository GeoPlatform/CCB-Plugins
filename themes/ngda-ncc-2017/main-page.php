		...
		<div class="line"></div>
              ...
              <div class="row">
               ...
               url(%4$s);" href="%1$s" alt="%2$s" class="media embed-responsive embed-responsive-16by9" id="module"><h3 id="mid">%3$s</h3></a>',
                                    ...
                                    esc_attr( sprintf( __( 'View all posts in %s', 'ngda-ncc-2017' ), $category->name ) ),
              ...
              <div class="gp-ui-card gp-ui-card--md gp-ui-card text-center">
                      ...
                      <?php echo sprintf( esc_html__( '%s', 'ngda-ncc-2017' ), $category_link ); ?>
...
<?php } ?>
<!-- <?php
                  // echo '<p>' . sprintf( esc_html__( 'Category: %s', 'ngda-ncc-2017' ), $category_link ) . '</p> ';
                  // echo '<p>' . sprintf( esc_html__( 'Description: %s', 'ngda-ncc-2017' ), $category->description ) . '</p>';
                  // echo '<p>' . sprintf( esc_html__( 'Post Count: %s', 'ngda-ncc-2017' ), $category->count ) . '</p>';
              //} ?> -->
