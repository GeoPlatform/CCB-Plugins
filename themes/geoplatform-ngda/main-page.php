...
<?php } ?>
<!-- <?php
                  // echo '<p>' . sprintf( esc_html__( 'Category: %s', 'ngda-2017' ), $category_link ) . '</p> ';
                  // echo '<p>' . sprintf( esc_html__( 'Description: %s', 'ngda-2017' ), $category->description ) . '</p>';
                  // echo '<p>' . sprintf( esc_html__( 'Post Count: %s', 'ngda-2017' ), $category->count ) . '</p>';
              //} ?> -->
