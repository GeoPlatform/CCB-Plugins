...
if (!empty($geopportal_post->post_excerpt))
  $geopccb_excerpt = esc_attr(wp_strip_all_tags($geopportal_post->post_excerpt));
else{
  $geopccb_excerpt = esc_attr(wp_strip_all_tags($geopportal_post->post_content));
  if (strlen($geopccb_excerpt) > 200)
    $geopccb_excerpt = esc_attr(wp_strip_all_tags(substr($geopccb_excerpt, 0, 200) . '...'));
}
?>
