  ...
  register_nav_menus(
    array(
      ...
      'headfoot-themes' => 'HF - Themes',
			...
			'headfoot-center' => 'HF - Center Column'
    )
  );
}
...
//-------------------------------
//Theme support for getting the name of a menu at a location
//https://developer.wordpress.org/reference/functions/wp_get_nav_menu_name/
//-------------------------------

function gp_get_nav_menu_name( $location ) {
    $menu_name = '';
...
add_action('init','gp_get_nav_menu_name');
