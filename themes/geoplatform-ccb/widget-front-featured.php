...
<!-- HTML for the widget control box. -->
		...
		<p>
      <label for="<?php echo $this->get_field_id( 'geopccb_featured_title' ); ?>">Section Title:</label>
      <input type="text" id="<?php echo $this->get_field_id( 'geopccb_featured_title' ); ?>" name="<?php echo $this->get_field_name( 'geopccb_featured_title' ); ?>" value="<?php echo esc_attr( $geopccb_featured_title ); ?>" />
    </p>
		<p>
      <label for="<?php echo $this->get_field_id( 'geopccb_community_link' ); ?>">Source Category:</label>
      <input type="text" id="<?php echo $this->get_field_id( 'geopccb_community_link' ); ?>" name="<?php echo $this->get_field_name( 'geopccb_community_link' ); ?>" value="<?php echo esc_attr( $geopccb_community_link ); ?>" />
    </p>
		<?php
	}
