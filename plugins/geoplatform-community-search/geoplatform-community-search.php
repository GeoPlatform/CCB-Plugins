...
function gpsearch_add_stylesheet() {
  wp_register_style('gpsearch', GP_SEARCH_URL . 'assets/css/geoplatform-community-search-core.css', array(), false, 'all');
...
function gpsearch_add_admin_script() {
  ...
  wp_register_script('clientapi', GP_SEARCH_URL . 'assets/js/geoplatform.client.min.js', array(), null);
  wp_enqueue_script('clientapi');
  wp_register_style('gpsearchadmin_css', GP_SEARCH_URL . 'assets/css/geoplatform-community-search-admin.css', false, 'all');
