...
function geopitems_page_enqueues(){
	if (is_page('geoplatform-items')){
		wp_enqueue_script( 'runtime_bundle',   plugin_dir_url( __FILE__ ) . 'public/js/runtime.js',   array(), false, true );
		wp_enqueue_script( 'polyfills_bundle', plugin_dir_url( __FILE__ ) . 'public/js/polyfills.js', array(), false, true );
		wp_enqueue_script( 'scripts_bundle',   plugin_dir_url( __FILE__ ) . 'public/js/scripts.js',   array(), false, true );
		wp_enqueue_script( 'main_bundle',      plugin_dir_url( __FILE__ ) . 'public/js/main.js',      array(), false, true );
		wp_enqueue_style( 'styles_bundle',     plugin_dir_url( __FILE__ ) . 'public/css/styles.css',  array(), false, 'all' );
	}
}
