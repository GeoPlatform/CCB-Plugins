...
class Geop_Search_Admin {
     ...
     * Add a settings page for this plugin to the Settings menu.
		 ...
		 *
		 */
		add_options_page( 'GeoPlatform Search Plugin Settings Page', 'GeoPlatform Search', 'edit_others_posts', $this->plugin_name, array($this, 'display_plugin_setup_page'));
	}
