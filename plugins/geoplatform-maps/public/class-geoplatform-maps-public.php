...
class Geop_Maps_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'geop_client_api', plugin_dir_url( __FILE__ ) . 'assets/geoplatform-client-node.umd.js', array( 'geop_axios' ), $this->version, false );
		wp_enqueue_script( 'geop_mapcore', plugin_dir_url( __FILE__ ) . 'assets/geoplatform-mapcore.umd.js', array( 'geop_axios' ), $this->version, false );
