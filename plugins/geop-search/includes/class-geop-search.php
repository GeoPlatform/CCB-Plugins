...
class Geop_Search {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Geop_Search_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Geop_Search_Loader. Orchestrates the hooks of the plugin.
	 * - Geop_Search_i18n. Defines internationalization functionality.
	 * - Geop_Search_Admin. Defines all hooks for the admin area.
	 * - Geop_Search_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Geop_Search_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Geop_Search_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Geop_Search_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Geop_Search_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Geop_Search_Loader    Orchestrates the hooks of the plugin.
	 */
